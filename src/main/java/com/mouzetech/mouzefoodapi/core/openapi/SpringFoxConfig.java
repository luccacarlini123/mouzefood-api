package com.mouzetech.mouzefoodapi.core.openapi;
...
import com.mouzetech.mouzefoodapi.api.exceptionhandler.Problem;
...
import com.mouzetech.mouzefoodapi.openapi.model.CidadeModelOpenApi;
import com.mouzetech.mouzefoodapi.openapi.model.CozinhaModelOpenApi;
import com.mouzetech.mouzefoodapi.openapi.model.EstadoModelOpenApi;
import com.mouzetech.mouzefoodapi.openapi.model.FormasPagamentoModelOpenApi;
import com.mouzetech.mouzefoodapi.openapi.model.GrupoModelOpenApi;
import com.mouzetech.mouzefoodapi.openapi.model.LinksModelOpenApi;
import com.mouzetech.mouzefoodapi.openapi.model.PageableModelOpenApi;
import com.mouzetech.mouzefoodapi.openapi.model.PedidoModelOpenApi;
import com.mouzetech.mouzefoodapi.openapi.model.PermissaoModelOpenApi;
import com.mouzetech.mouzefoodapi.openapi.model.ProblemaNotFoundOpenApi;
import com.mouzetech.mouzefoodapi.openapi.model.ProdutoModelOpenApi;
import com.mouzetech.mouzefoodapi.openapi.model.RestauranteModelOpenApi;
import com.mouzetech.mouzefoodapi.openapi.model.UsuarioModelOpenApi;
...
public class SpringFoxConfig implements WebMvcConfigurer {
	...
	public Docket apiDocket() {
		...
		return new Docket(DocumentationType.OAS_30)
				.select()
				.apis(RequestHandlerSelectors.basePackage("com.mouzetech.mouzefoodapi.api"))
...
//						))
	...
	private Consumer<RepresentationBuilder> getProblemaModelReference() {
	    return r -> r.model(m -> m.name("Problema")
	            .referenceModel(ref -> ref.key(k -> k.qualifiedModelName(
	                    q -> q.name("Problema").namespace("com.mouzetech.mouzefoodapi.api.exceptionhandler")))));
	}
	...
	private Consumer<RepresentationBuilder> getProblemaNotFoundModelReference() {
	    return r -> r.model(m -> m.name("ProblemaNotFoundOpenApi")
	            .referenceModel(ref -> ref.key(k -> k.qualifiedModelName(
	                    q -> q.name("ProblemaNotFoundOpenApi").namespace("com.mouzetech.mouzefoodapi.openapi.model")))));
	}
